...
There was a nummeric difference in time to recurrence in the 3 different RBC.Age.Group` levels.
The mean time to recurrence in group 1,2 and 3 was 238, 215 and 238. 
As the histogram illustrates the data was not normally distributed.
Using Anova an Kruskal-Wallis test,
both indicates that the difference is not statistically significant with p values of 0,775 and 0,592.
...
<br>
The time to recurrence was clealy different between the two T-stage groups.
...
The differende can altso be viaualised by a boxplot.
...
the difference is higly statistically  significant with a p value of 0,0048
<br>
<br>
...
while the time to recurrence for the patient having  'AdjRadTherapy' was 59 days
...
<br>
Patients having recurrence had larger 'Tvol'.
2 out of 64 (3 %) patients with Tvol = 1 had Recurrence.
19 out of 153 (7%) patienst with Tvol = 2 had Recurence.
30 out of 93 (20%) patienst with Tvol = 3 had Recurrence.
<br>
<br>
